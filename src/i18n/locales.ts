...
const en = {
  ...
  "apiDocs.overviewText": "The Gut Microbiome Atlas API provides programmatic access to 168,464 human gut microbiome samples across 4,680 genera, 66 countries, and 217+ diseases. All endpoints return JSON responses.",
  ...
  "cite.dataSourcesText": "Gut Microbiome Atlas integrates 168,464 human gut 16S rRNA gene sequencing samples from public repositories including NCBI SRA, ENA, and DDBJ. Samples span 66 countries, 217+ disease conditions, and 8 life stages from Infant to Centenarian.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  "apiDocs.overview": "概述",
  "apiDocs.overviewText": "肠道微生物图谱 API 提供对 168,464 份人类肠道微生物样本的编程访问，涵盖 4,680 个属、66 个国家和 217+ 种疾病。所有端点返回 JSON 格式数据。",
  "apiDocs.auth": "认证",
  ...
  "cite.dataSourcesText": "肠道微生物图谱整合了来自 NCBI SRA、ENA 和 DDBJ 等公共数据库的 168,464 份人类肠道 16S rRNA 基因测序样本，覆盖 66 个国家、217+ 种疾病状态和从婴儿到百岁老人的 8 个生命阶段。",
