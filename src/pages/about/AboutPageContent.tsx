...
const COPY: Record<"en" | "zh", Copy> = {
  en: {
    ...
    dataIntro:
      "GutBiomeDB integrates processed human gut microbiome cohorts retrieved from public repositories and harmonizes them into a genus-level analysis layer for cross-study exploration, visualization, and hypothesis generation. The current release covers 224 non-NC condition labels plus one NC category, yielding 225 condition categories in total.",
  ...
  zh: {
    ...
    dataIntro:
      "GutBiomeDB 整合公开数据库中的人类肠道微生物组队列，并统一到 genus 层级分析框架中，用于跨研究浏览、可视化和假设生成。当前发布版本包含 224 个非 NC 条件标签，另加 1 个 NC 类别，共 225 个条件类别。",
    sourceLabel: "数据来源",
    pipelineLabel: "处理流程",
    statsLabel: "当前数据快照",
    citeIntro:
